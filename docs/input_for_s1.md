...
![Fig. 1: Central Z-slice from an example input tomogram](images/input_tomo_example.png){: style="width: 300px; display: block; margin-left: auto; margin-right: auto;"}
<div align="center">
...
![Fig. 2: Z-slice bounds for the two steps in PickET](images/Zbounds.png)
<div align="center">
